...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE      38400 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_MICROSTEPS_GOTO    8 //    OFF, n. Goto microstep mode override. OFF uses _DRIVER_MICROSTEPS.            Option

// for TMC2130, TMC5160, TMC2209, TMC2226 STEP/DIR driver models:
#define AXIS1_DRIVER_IHOLD            OFF //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS1_DRIVER_IRUN             750 //    OFF, n, (mA.) Default run current, appropriate for stepper/driver/etc.        Option
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE      38400 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_MICROSTEPS_GOTO    8 //    OFF, n. Goto microstep mode override. OFF uses _DRIVER_MICROSTEPS.            Option

// for TMC2130, TMC5160, TMC2209, TMC2226 STEP/DIR driver models:
#define AXIS2_DRIVER_IHOLD            OFF //    OFF, n, (mA.) Current during standstill. OFF uses IRUN/2.0                    Option
#define AXIS2_DRIVER_IRUN             750 //    OFF, n, (mA.) Default run current, appropriate for stepper/driver/etc.        Option
...
#define PEC_STEPS_PER_WORM_ROTATION 38400 //      0, n. Steps per worm rotation (0 disables else 720 sec buffer allocated.)  <-Req'd
...
#define AXIS4_DRIVER_MICROSTEPS         8 //    OFF, n. Default microstep mode.                                               Option
...
#define AXIS4_DRIVER_IRUN             200 //    OFF, n, (mA.) Default run current, appropriate for stepper/driver/etc.        Option
